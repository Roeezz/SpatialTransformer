...
def visualize_stn(epoch, test_loader, writer):
    with torch.no_grad():
        ...
        writer.add_images('Image/Fake_frame', fake_ending.permute(0, 2, 1, 3, 4).view(-1, C, H, W), epoch)
...
if __name__ == '__main__':
    ...
    train_loader = DataLoader(train_video_dataset, batch_size=1, drop_last=True, num_workers=2, shuffle=True)
